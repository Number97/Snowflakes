class Snowflake
{
    constructor(_x,_y,_diametre,_flakediametre,_oscillationMinimum,_oscillationWidth,_style)
    {
        this.x = _x
        this.y = _y
        ...
        this.current = 0
        this.snowflakes.push(new Particle(this.diametre/2,0,this.x,this.y,this.flakediametre,this.oscillationMinimum,this.oscillationWidth,false,_style))
        this.style = _style
    }
    ...
    advance()
    {
        ...
        if(this.checkContact())
        {
            ...
            this.createMirrors()
            this.snowflakes.push(new Particle(this.diametre/2,0,this.x,this.y,this.flakediametre,this.oscillationMinimum,this.oscillationWidth,false,this.style))
            this.current++
        }
        else
        {
    ...
    createMirrors()
    {
        this.snowflakes.push(new Particle(this.snowflakes[this.current].x,-this.snowflakes[this.current].y,this.x,this.y,this.flakediametre,this.oscillationMinimum,this.oscillationWidth,true,this.style))
        this.current++
        this.snowflakes[this.current].show()
